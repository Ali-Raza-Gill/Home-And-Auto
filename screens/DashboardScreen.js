...
//       <Text className="text-slate-500 mb-4">Here's a concise snapshot of your homes, vehicles and service ecosystem.</Text>

//       <View className="grid grid-cols-2 gap-3">
//         <Card title="Home Profiles" value={stats.homes} className="col-span-1" />
//         <Card title="Vehicle Profiles" value={stats.vehicles} className="col-span-1" />
//         <Card title="Service Providers" value={stats.providers} className="col-span-1" />
//         <Card title="Notifications" value={stats.notifications} className="col-span-1" />
//       </View>

//       <View className="mt-6">
//         <Text className="font-semibold mb-2">Quick Actions</Text>
//         <View className="gap-3">
//           <Button title="Add New Home" onPress={() => navigation.navigate("Homes")} />
//           <Button title="Add New Vehicle" onPress={() => navigation.navigate("Vehicles")} />
//           <Button title="Find Service Provider" onPress={() => navigation.navigate("Service Providers")} />
//           <Button title="Create Community Post" onPress={() => navigation.navigate("Community")} />
//         </View>
//       </View>
//     </ScrollView>
//   );
