...
//       <Text className="text-2xl font-bold mb-4">{isAdd ? "Add Home" : "Edit Home"}</Text>
...
//       <Input label="Notes" value={form.notes} onChangeText={(t)=>setForm({...form, notes: t})} />
//       <Button title={isAdd ? "Add Home" : "Save"} onPress={save} loading={saving} />
//     </ScrollView>
//   );
// }
