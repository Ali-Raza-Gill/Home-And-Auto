...
//       <Text className="text-2xl font-bold mb-3">Notifications</Text>
//       <View className="gap-3">
//         {items.map((n) => (
//           <Card key={n.id}>
//             <Text className="font-semibold">{n.title || "Reminder"}</Text>
//             <Text className="text-slate-500 mt-1">Due {n.due_date ? dayjs(n.due_date).format("MMM D, YYYY") : "—"}</Text>
//             {!n.done && <TouchableOpacity onPress={() => markDone(n.id)} className="mt-2">
//               <Text className="text-haa-accent">Mark done</Text>
//             </TouchableOpacity>}
//           </Card>
//         ))}
//         {items.length === 0 && <Text className="text-slate-500">No active notifications.</Text>}
//       </View>
//     </ScrollView>
//   );
// }
